    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='yzminfo.YzmInfo', verbose_name='爬虫')),
            ],
            options={
                'verbose_name': '监控信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('yzmmodel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='yzminfo.YzmModel', verbose_name='模型名称')),
            ],
            options={
                'verbose_name': '爬虫信息',
